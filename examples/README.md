...
- `examples/strategies/usdm_long_short_backtest.palm`: Binance USD-M BTCUSDT long/short strategy with symmetric multi-timeframe breakout entries, attached mark-triggered `protect` exits, and hybrid fixed-or-ATR `target` exits on both sides
