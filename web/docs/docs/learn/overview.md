...
- deterministic overfitting-risk summaries, validation-constraint summaries, baseline comparisons, bounded date-perturbation reruns for top-level backtests, optimize holdout pass-rate data, and improvement hints that stay conservative when no out-of-sample evidence exists
