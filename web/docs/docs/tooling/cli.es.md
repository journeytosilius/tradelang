...
elegir una estrategia de forma explicita, cambiar entre las ejecuciones
seguidas de esa estrategia e inspeccionar equity, PnL, trades, drawdown, salud
de feeds y logs en tiempo real.
