...
- si l'un de ces endpoints auxiliaires Binance USD-M ne renvoie aucune ligne pour la fenetre demandee, la session paper continue maintenant son armement et expose ce champ comme `na` au lieu d'echouer entierement
