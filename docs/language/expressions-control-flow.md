...
TradeLang supports arithmetic, comparisons, logical operators, unary operators, indexing, function calls, and conditional blocks.
...
TradeLang supports `if`, `else if`, and `else`:
