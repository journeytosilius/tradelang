...
pub use backtest::{
    ...
    BacktestSummary, BaselineComparisonSummary, BoolExportDiagnosticSummary, CohortDiagnostics,
    ConstraintFailureBreakdown, DatePerturbationDiagnostics, DatePerturbationKind,
    DatePerturbationScenarioSummary, DecisionReason, DiagnosticsDetailMode,
    DirectValidationDriftSummary, DrawdownDiagnostics, EntryModuleDiagnosticSummary, EquityPoint,
    ExportDiagnosticSummary, ExportValueType, FeatureSnapshot, FeatureValue, FeeSchedule, Fill,
    FillAction, ForwardReturnMetric, InputSweepDefinition, NumericExportDiagnosticSummary,
    OpportunityEvent, OpportunityEventKind, OptimizeCandidateSummary, OptimizeConfig,
    OptimizeDirectValidationResult, OptimizeError, OptimizeEvaluationSummary,
    OptimizeHoldoutConfig, OptimizeHoldoutResult, OptimizeObjective, OptimizeParamSpace,
    OptimizePreset, OptimizeProgressEvent, OptimizeProgressListener, OptimizeProgressState,
    OptimizeResult, OptimizeResumeState, OptimizeRunner, OptimizeScheduledBatch,
